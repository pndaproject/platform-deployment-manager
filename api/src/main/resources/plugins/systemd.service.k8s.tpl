...
ExecStart=${environment_spark_submit} --driver-java-options "-Dlog4j.configuration=file:////opt/${environment_namespace}/${component_application}/${component_name}/log4j.properties" --class ${component_main_class} --name '${component_job_name}' --master '${component_k8s_master_url} --deploy-mode client --files log4j.properties ${component_spark_submit_args} ${component_main_jar}
